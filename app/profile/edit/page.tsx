...
const [formData, setFormData] =
    useState({full_name: "",username: "",bio: "",gender: "male" as "male" | "female" | "other",birthdate: "",avatar_url: "",});
  ...
  async function handleFormSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      if (result.success) {router.push("/profile");} else {
            ...
            <div className="mb-8">
              ...
              <div className="flex items-center space-x-6">
                <div className="relative">
                  ...
                  <PhotoUpload
                    onPhotoUploaded={(url) => {setFormData((prev) => ({...prev, avatar_url:url}));}}
